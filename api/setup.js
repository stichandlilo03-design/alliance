...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    if (parseInt(rows[0].count) === 0) {
      ...
      await sql`
        ...
        VALUES (
          ...
          '[{"id":"693660676f618","type":"deposit","amount":45000000,"description":"Mobile Deposit #728372892","date":"2025-12-08 13:21:43","status":"approved"}]'::jsonb,
      ...
      await sql`
        ...
        VALUES (
          ...
          '[{"id":"6936cca4dc369","type":"deposit","amount":52000000,"description":"Mobile Deposit #728372892","date":"2025-12-08 21:03:32","status":"approved"}]'::jsonb,
    ...
    return res.status(200).json({
      success: true,
      message: 'Database tables created and seed data loaded!'
    });
  } catch (err) {
